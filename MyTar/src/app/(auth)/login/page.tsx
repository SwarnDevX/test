      ...
      <div className="w-full max-w-md px-8 py-10 bg-white/5 border border-white/10 rounded-2xl backdrop-blur">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            ...
            className="w-full border border-white/20 hover:bg-white/5 text-white font-medium py-2.5 rounded-lg transition-colors text-sm flex items-center justify-center gap-2"
          >
